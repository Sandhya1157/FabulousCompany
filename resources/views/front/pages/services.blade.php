  ...
  <style type="text/css">
      .itback{
        background-image: url("{{asset('images/services/tab.jpg')}}");
      ...
      .services{
        background-image:url("{{asset('images/services/services.jpg')}}");
        background-repeat: no-repeat;
        background-attachment: fixed;
        width: 100%;
        background-size: cover;
   ...
   <div class="row" > 
     <div class="col-lg-8 col-md-8 col-sm-4 pt-3 "  data-aos="fade-right" data-aos-duration="3000">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12" data-aos="fade-left" data-aos-duration="3000">
        <img src= "{{asset('images/services/itimage.png')}}" height="300">
      </div>
   </div>
   <div>
 ...
 <div class="container">
   ...
   <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12"data-aos="fade-right" data-aos-duration="3000">
        <img src="{{asset('images/services/ele.png')}}" height="300">
      </div>
